...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      custom_nord.normal.c.bg = colors.line_bg
      custom_nord.normal.b.fg = colors.gray
      custom_nord.normal.a.fg = colors.gray
      custom_nord.normal.c.fg = colors.gray
          ...
          lualine_a = {
            {
              ...
              separator = "",
              color = { fg = colors.blue, bg = colors.line_bg},
            },
            { 
              'mode',
              fmt =  function(str)
          ...
          lualine_b = {
            {
              ...
              color = { fg = colors.gray, bg = colors.line_bg },
            },
            {
              function() return "/" end,
              padding = 0,
            ...
            },
            {
              ...
              file_status = true,
              path = 0,
              color = { fg = colors.purple, bg = colors.line_bg, gui = 'bold'},
              separator = {right = ''},
            }
          },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>i', vim.lsp.buf.hover, '[H]over [I]mplementation')
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
            map('<leader>hs', vim.lsp.buf.document_highlight, '[H]ighlight [D]efinitions')
      ...
      local servers = {
        clangd = {
          mason = false, -- Disable mason for clangd, since it is already installed via `clangd` package
          keys = {
      ...
      local ensure_installed = { "gopls", "lua_ls" }
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --local sm = statusline.section_mode
      --statusline.section_mode = function(args)
        --local mode, hl = sm(args)
        --return ' ', hl
      --end
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      parser_config.asciidoc = {
        install_info = {
          url = "~/git/tree-sitter-asciidoc/tree-sitter-asciidoc",
      ...
      parser_config.asciidoc_inline = {
        install_info = {
          url = "~/git/tree-sitter-asciidoc/tree-sitter-asciidoc_inline",
          files = {"src/parser.c", "src/scanner.c"},
          branch = "main",
          generate_requires_npm = false,
          requires_generate_from_grammar = false,
